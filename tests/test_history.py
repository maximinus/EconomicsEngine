...
class TestBaseStats(unittest.TestCase):
    def setUp(self):
        ...
        self.history.update([Trans(PRODUCT_A, 5, 6), Trans(PRODUCT_A, 3, 8), Trans(PRODUCT_B, 2, 5)])
        self.history.update([Trans(PRODUCT_A, 8, 7), Trans(PRODUCT_A, 9, 6)])
        self.history.update([Trans(PRODUCT_A, 3, 5), Trans(PRODUCT_A, 4, 6), Trans(PRODUCT_B, 2, 5)])
    ...
    def test_historical_price(self):
        ...
        self.assertAlmostEqual(price, 6.34, delta=0.01)
